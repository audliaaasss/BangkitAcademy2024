...
class HomeFragment : Fragment() {
    ...
    private fun setupRecyclerViews() {
        ...
        binding.rvUpcomingEvents.addItemDecoration(itemDecorationUpcoming)
        ...
        binding.rvFinishedEvents.layoutManager = layoutManagerFinished
        val itemDecorationFinished = DividerItemDecoration(requireActivity(), layoutManagerFinished.orientation)
        binding.rvFinishedEvents.addItemDecoration(itemDecorationFinished)
